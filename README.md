...
The ibm-monitoring-grafana-operator and Grafana operands run under OpenShift Container Platform default restricted security context constraints.
...
For more instructions on how to run end-to-end testing with Operand Deployment Lifecycle Manager, see [ODLM guide](https://github.com/IBM/operand-deployment-lifecycle-manager/blob/master/docs/dev/e2e.md).
